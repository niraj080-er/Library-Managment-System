    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                <Button class="rbgbtn" >Welcome</Button>
                <Button class="rbgbtn" onclick="openpart('myaccount')"> My Account</Button>
                <Button class="rbgbtn" onclick="openpart('requestbook')"> Request Book</Button>
                <Button class="rbgbtn" onclick="openpart('issuereport')"> Book Report</Button>
            ...
            <Button class="rbgbtn" >My Account</Button>
            ...
            <Button class="rbgbtn" >ISSUE RECORD</Button>
            ...
            <Button class="rbgbtn" >Return Book</Button>
            ...
            <Button class="rbgbtn" >Request Book</Button>
