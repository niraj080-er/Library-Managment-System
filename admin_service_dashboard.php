...
.innerright {
    background-color:rgb(143 237 143 / 59%);
}

.rbgbtn {
    background-color: rgb(234 153 64);
    color: white;
    width: 95%;
    height: 40px;
    margin-top: 8px;
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                <Button class="rbgbtn"> ADMIN</Button>
                <Button class="rbgbtn" onclick="openpart('addbook')" >ADD BOOK</Button>
                <Button class="rbgbtn" onclick="openpart('bookreport')" > BOOK REPORT</Button>
                <Button class="rbgbtn" onclick="openpart('bookrequestapprove')"> BOOK REQUESTS</Button>
                <Button class="rbgbtn" onclick="openpart('addperson')"> ADD STUDENT/TEACHER</Button>
                <Button class="rbgbtn" onclick="openpart('studentrecord')"> STUDENT REPORT</Button>
                <Button class="rbgbtn"  onclick="openpart('issuebook')"> ISSUE BOOK</Button>
                <Button class="rbgbtn" onclick="openpart('issuebookreport')"> ISSUE REPORT</Button>
                <a href="login.php"><Button class="rbgbtn" > LOGOUT</Button></a>
            </div>

            <div class="rightinnerdiv">   
            <div id="bookrequestapprove" class="innerright portion" style="display:none">
            <Button class="rbgbtn" >BOOK REQUEST APPROVE</Button>
            ...
            <Button class="rbgbtn" >ADD NEW BOOK</Button>
            ...
            <div>Branch:<input type="radio" name="branch" value="CSE"/>CSE <input type="radio" name="branch" value="IT"/>IT
              <input type="radio" name="branch" value="EEE"/>EEE<input type="radio" name="branch" value="ECE"/>ECE
            <input type="radio" name="branch" value="BME"/>BME<input type="radio" name="branch" value="FOOD"/>FOOD
            <div style="margin-left:70px">
            <input type="radio" name="branch" value="AERO"/>AERO<input type="radio" name="branch" value="MECH"/>MECH
            <input type="radio" name="branch" value="AGRI"/>AGRI<input type="radio" name="branch" value="CIVIL"/>CIVIL  <input type="radio" name="branch" value="OTHER"/>OTHER</div>
           </div>   
            ...
            <Button class="rbgbtn" >ADD PERSON</Button>
            ...
            <Button class="rbgbtn" >STUDENT RECORD</Button>
            ...
            <Button class="rbgbtn" >ISSUE BOOK REPORT</Button>
...
<!--issue book -->
            ...
            <Button class="rbgbtn" >ISSUE BOOK</Button>
...
<br>
            ...
            <Button class="rbgbtn" >BOOK DETAIL</Button>
</br>
<?php
            $u=new data;
            $u->setconnection();
...
?>
            ...
            <Button class="rbgbtn" >BOOK RECORD</Button>
            <?php
            $u=new data;
            $u->setconnection();
            $u->getbook();
